...
function [out1,out2,out3] = ginputColour(arg1,arg2)
...
global colourVar
for k = 1:4
    crossHair(k) = uicontrol(fig, 'Style', 'text', 'Visible', 'off', 'Units', 'pixels', 'BackgroundColor', colourVar, 'HandleVisibility', 'off', 'HitTest', 'off'); %#ok<AGROW>
end
end
